...
class TrafficUi(QMainWindow):
    def __init__(self):
        ...
        oImage = QImage("./Resources/b1.jpg")
        ...
        self.traffic_h_pixmap = QPixmap('./Resources/traffic_lamp2.png')
        ...
        self.traffic_h2_pixmap = QPixmap('./Resources/traffic_lamp2.png')
        ...
        self.traffic_v_pixmap = QPixmap('./Resources/traffic_lamp.png')
        ...
        self.traffic_v2_pixmap = QPixmap('./Resources/traffic_lamp.png')
        ...
        self.red_pixmap = QPixmap('./Resources/red.png')
        ...
        self.red_pixmap2 = QPixmap('./Resources/red.png')
        ...
        self.red_pixmap3 = QPixmap('./Resources/red.png')
        ...
        self.red_pixmap4 = QPixmap('./Resources/red.png')
        ...
        self.yellow_pixmap = QPixmap('./Resources/yellow.png')
        ...
        self.yellow_pixmap2 = QPixmap('./Resources/yellow.png')
        ...
        self.yellow_pixmap3 = QPixmap('./Resources/yellow.png')
        ...
        self.yellow_pixmap4 = QPixmap('./Resources/yellow.png')
        ...
        self.green_pixmap = QPixmap('./Resources/green.png')
        ...
        self.green_pixmap2 = QPixmap('./Resources/green.png')
        ...
        self.green_pixmap3 = QPixmap('./Resources/green.png')
        ...
        self.green_pixmap4 = QPixmap('./Resources/green.png')
    ...
    def runMethod_(self):
        ...
        self.file_emer = open('./Resources/text_files/emer.txt', 'r+')
        ...
        while (True):
            QApplication.processEvents()
            self.file = open('./Resources/text_files/val.txt', 'r+')
            self.file_read = self.file.read()
            self.cont = self.file_read[1:-1]
            self.cont = self.cont.replace(',', '')
            self.east_st, self.south_st, self.west_st, self.north_st = self.cont.split(' ')
