...
def emergency_audio(clip_east_path,clip_south_path,clip_west_path,clip_north_path,model_path):
    ...
    audio_east = clip_east.audio.to_soundarray()
    audio_south = clip_south.audio.to_soundarray()
    audio_west = clip_west.audio.to_soundarray()
    audio_north = clip_north.audio.to_soundarray()

    sf.write(conv_file+"east.wav", audio_east, samplerate=16000)
    sf.write(conv_file + "south.wav", audio_south, samplerate=16000)
    sf.write(conv_file + "west.wav", audio_west, samplerate=16000)
    sf.write(conv_file + "north.wav", audio_north, samplerate=16000)
